Handlebars.registerPartial("data-table", Handlebars.template({"1":function(depth0,helpers,partials,data) {
...
this["SlideVendorTemplates"]["form"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, buffer = "<div class=\"data-table-control\" style=\"margin-bottom: 16px;\">\n  <div class=\"download-controls\">\n    <button class=\"control new-form\"><span class=\"glyphicon glyphicon-plus\"></span> Create new form</button>\n  </div>\n</div>\n";
  stack1 = this.invokePartial(partials['data-table'], '', 'data-table', depth0, undefined, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
  return buffer;
...
this["SlideVendorTemplates"]["forms"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "  <div class=\"data-table-control\" data-form="
    + escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"id","hash":{},"data":data}) : helper)))
